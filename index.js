...
class PdfQa{
    ...
    constructor({model,pdfDocument,chunkSize,chunkOverlap,kdocuments,searchType}){
        this.model=model;
    ...
    async documentLoader(){
        ...
        const loader= new PDFLoader(path.join(import.meta.dirname,this.pdfDocument));
...
//console.log("chk22")
 const query2 = 'What problem it creates?';
